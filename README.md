...
This cozy and pleasant weather app allows users to search for a particular city and get daily and weekly forecasts with all the necessary information such as temperature, pressure, humidity, wind, etc. Data is being fetched from [OpenWeather.org](https://openweathermap.org/) website.

## Project status

Features that are planned to develop in the future:

- Sidebars with some additional information.
...
- By clicking on the arrow on the "search" panel you can choose a city or type it manually.
- The "Search" function has the ability to autocomplete.
- By clicking on each item on the daily forecast panel the modal with additional information is displayed.
- By clicking on the item again the modal with information collapses.

---

## Project demo picture

<img src="./src/media/DemoPic1.png" width=600px height=350px/>
